...
class DirectPost:
    ...
    def post_text(account_id, text):
        ...
        try:
            # アカウント情報
            account_data = {
                "user_id": "10068250716584647",  # 実際のユーザーID
                "username": account_id
            }
    ...
    def post_reply(account_id, text, reply_to_id):
        ...
        try:
            ...
            if result and "id" in result:
                ...
                print(f"✅ リプライ成功: {reply_id}")
                return {
                    "success": True,
                    "reply_id": reply_id
                }
            else:
                print(f"❌ リプライ失敗: {result}")
                return {
                    "success": False,
                    "error": str(result)
                }
...
class ThreadsAutomationSystem:
    ...
    def single_post(self, account_id: str = None, test_mode: bool = False, custom_text: str = None):
        """単発投稿実行"""
        print("\n🎯 === 単発投稿実行 ===")
        ...
        try:
            ...
            reply_post_id = reply_result.get("reply_id") if reply_result.get("success") else None
            ...
            try:
                ...
                if account_id:
                    ...
                    if result and result.get("success"):
                        ...
                        print(f"🔗 投稿URL: https://threads.net/@kanae_15758/post/{post_id}")
                    else:
